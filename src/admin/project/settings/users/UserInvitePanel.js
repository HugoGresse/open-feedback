...
const schema = object().shape({
    email: string()
        ...
        .required('The member email is required. You think you can invite Nobody? Well... no.')
})
...
const UserInvitePanel = ({isOpen, onClose, onSubmit}) => {
    ...
    return <Drawer anchor="right"
                   ...
                   open={isOpen}
                   onClose={onClose}>
        <SidePanelLayout title="Add a new member to the event" onClose={onClose}>
            <Formik
                ...
                {({isSubmitting}) => (
                    <Form method="POST">
                        ...
                        <OFButton
                            ...
                            type="submit"
                            style={{type: 'big', marginTop: 64, width: '100%'}}
                        >
                            Add member
                        </OFButton>
                    </Form>
