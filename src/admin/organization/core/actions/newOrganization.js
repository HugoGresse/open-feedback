...
export const newOrganization = (name) => async (dispatch, getState) => {
    ...
    const orgData = {
        ...
        faviconUrl: `${window.location.protocol}//${window.location.host}/favicon-32x32.png`,
        logoUrl: `${window.location.protocol}//${window.location.host}/android-chrome-192x192.png`,
